...
/// <see cref="Parent"/>; everything else names its continent and (in practice, after the empty-layers
/// filter in <c>PackageBuilder</c>) is a country carrying one or more ISO 3166-1 codes.
/// <see cref="World"/> is synthetic and merges every continent.
/// </summary>
